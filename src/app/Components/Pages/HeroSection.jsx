...
// //         >
// //             {/* 1. Left Sidebar Split */}
// //             <div className={`absolute inset-0 w-1/3 transition-colors duration-1000 ${isDarkMode ? "bg-[#1f1226]" : "bg-white"}`} />

// //             {/* --- Navigation --- */}
// //             <nav className="relative z-50 flex justify-between items-center px-12 py-8 max-w-[1600px] w-full mx-auto">
// //                 <motion.h1
...
// //             {/* --- Main Content --- */}
// //             <main className="relative z-10 max-w-[1600px] w-full mx-auto px-12 grid md:grid-cols-2 gap-20 items-center flex-grow">
...
// //                     <FloatingSymbol x="70%" y="60%" size="3rem" delay={4}>#</FloatingSymbol>
...
// //                     <div className="absolute top-[-150px] left-1/2 -translate-x-1/2 flex flex-col items-center z-30">
// //                         {/* 1. The Wire */}
// //                         <div className="w-[1.5px] h-48 bg-gray-500/40" />
...
// //                     {/* --- Desk Elements --- */}
// //                     <div className="relative w-full flex justify-center items-end pb-12 gap-6">
...
// //                             <motion.div
// //                                 className="w-80 h-52 rounded-2xl border-[10px] relative overflow-hidden transition-all duration-700 z-10"
// //                                 style={{
...
// //                                 className="relative w-8 h-40 rounded-sm shadow-xl flex flex-col items-center py-4 cursor-pointer"
// //                                 style={{
...
// //                             <motion.div
// //                                 whileHover={{ y: -10, transition: { type: "spring", stiffness: 300 } }}
// //                                 className="relative w-7 h-32 rounded-sm shadow-xl flex flex-col items-center justify-between py-6 cursor-pointer"
// //                                 style={{
...
// //                                 className="relative w-9 h-44 rounded-sm shadow-2xl flex flex-col items-center py-8 cursor-pointer origin-bottom"
// //                                 style={{
...
// //                     >
// //                         <p className="font-mono text-xl font-bold tracking-widest mb-4" style={{ color: isDarkMode ? "#ae8fdb" : "#2d2d2d" }}>
// //                             &gt; HI, I'M AVANI
// //                         </p>
// //                         <h2
...
// //                         >
// //                             I BUILD <br />
// //                             <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-300 via-purple-400 to-pink-400 animate-gradient-x">
// //                                 IMPOSSIBLE
// //                             </span> <br />
// //                             THINGS.
// //                         </h2>
...
// //                     <motion.p
// //                         className="text-2xl font-medium max-w-lg leading-relaxed opacity-70"
// //                         style={{ color: colors.text }}
// //                     >
// //                         Specializing in interactive SVG animations and high-performance React architectures.
// //                     </motion.p>
...
// //                             whileTap={{ scale: 0.95 }}
// //                             className="px-10 py-5 rounded-2xl font-black text-white transition-all"
// //                             style={{ backgroundColor: isDarkMode ? "#ae8fdb" : "#2d2d2d" }}
// //                         >
// //                             EXPLORE WORK
// //                         </motion.button>
// //                         <motion.button
// //                             whileHover={{ scale: 1.05 }}
// //                             className={`px-10 py-5 rounded-2xl font-black border-4 transition-all ${isDarkMode ? 'border-white text-white' : 'border-black text-black'}`}
// //                         >
// //                             READ BLOG
// //                         </motion.button>
// //                     </motion.div>
...
// //                         <p className="font-mono text-lg font-bold tracking-tight mb-2" style={{ color: isDarkMode ? "#dab2ff" : "#657e86" }}>
// //                             Hi, my name is
// //                         </p>

// //                         {/* Name - Huge and Bold */}
// //                         <h2 className="text-3xl md:text-6xl font-black leading-[1.1] tracking-tighter" style={{ color: colors.text }}>
// //                             Avani Tejani.
// //                         </h2>

// //                         {/* Catchphrase - Muted tone */}
// //                         <h3 className="text-2xl md:text-4xl font-black leading-[1.1] tracking-tighter opacity-40" style={{ color: colors.text }}>
// //                             I build things for the web.
// //                         </h3>
// //                     </motion.div>

// //                     {/* The Brief - Skill focused narrative */}
// //                     <motion.p
// //                         className="text-md md:text-lg font-medium max-w-xl leading-relaxed opacity-70"
// //                         style={{ color: colors.text }}
// //                     >
...
// //                         className="flex flex-wrap gap-3 font-mono text-sm opacity-50" style={{ color: colors.text }}>
...
// //                     {/* Buttons */}
// //                     <motion.div className="flex gap-6 pt-4">
// //                         <motion.button
// //                             whileHover={{ scale: 1.05, boxShadow: "0 20px 40px rgba(0,0,0,0.2)" }}
// //                             whileTap={{ scale: 0.95 }}
// //                             className="px-10 py-4 rounded-xl font-black text-white transition-all text-sm tracking-widest uppercase"
...
// //                             className={`px-10 py-4 rounded-xl font-black border-2 transition-all text-sm tracking-widest uppercase ${isDarkMode ? 'border-white text-white' : 'border-[#467b6c] text-[#467b6c]'}`}
// //                         >
// //                             Resume
// //                         </motion.button>
// //                     </motion.div>
...
//     // --- Global Theme Connection (Replacing local state) ---
...
//     return (
//         <div
//             className="h-full transition-colors duration-1000 ease-in-out relative overflow-hidden flex flex-col"
//             style={{ backgroundColor: colors.bg }}
//         >
//             {/* 1. Left Sidebar Split */}
//             <div className={`absolute inset-0 w-1/3 transition-colors duration-1000 ${isDarkMode ? "bg-[#1f1226]" : "bg-white"}`} />
...
//             {/* --- Main Content --- */}
//             <main className="relative z-10  w-[90%] mx-auto px-12 grid md:grid-cols-2 gap-5 md:gap-20 lg:gap-10 items-center flex-grow">
...
//                 <div className="relative h-[300px] md:h-[500px] flex items-end justify-center">
...
//                     <div className="absolute top-[-150px] left-1/2 -translate-x-1/2 flex flex-col items-center z-30">
//                         {/* 1. The Wire */}
//                         <div className="w-[1.5px] h-30 bg-gray-500/40" />
...
//                     {/* --- Desk Elements --- */}
//                     <div className="relative w-full flex justify-center items-end pb-12 gap-3">
...
//                 {/* RIGHT: TEXT CONTENT */}
//                 <div className="space-y-8 mb-5 pl-1 text-justify">
//                     <motion.div
//                         initial={{ opacity: 0, x: 100 }}
//                         animate={{ opacity: 1, x: 0 }}
//                         transition={{ duration: 1 }}
...
//                     {/* The Brief - Skill focused narrative */}
//                     <motion.p
//                         className="text-sm md:text-md font-medium max-w-xl leading-relaxed opacity-70"
//                         style={{ color: colors.text }}
//                     >
//                         I’m a <span className={isDarkMode ? "text-purple-300" : "text-[#185c48]"}>Frontend Developer</span> specializing in architecting high-performance, scalable web applications. Currently, I'm focused on building clean, maintainable digital experiences using the
//                         <span className="italic"> React & Next.js</span> ecosystem.
...
//                     {/* Buttons */}
//                     <motion.div className="flex flex-row  md:flex-col lg:flex-row gap-6 pt-4">
//                         <motion.button
//                             whileHover={{ scale: 1.05, boxShadow: "0 20px 40px rgba(0,0,0,0.2)" }}
//                             whileTap={{ scale: 0.95 }}
...
const Herosection = () => {
    ...
    return (
        ...
        >
            ...
            {/* --- Navigation --- */}
            <nav className="relative z-50 flex justify-between items-center px-6 md:px-12 py-6 md:py-8 max-w-[1600px] w-full mx-auto">
                <motion.h1
                    whileHover={{ scale: 1.05 }}
                    className="text-4xl font-[900] tracking-tighter cursor-pointer relative group"
                    style={{
        ...
        ${isDarkMode ? 'bg-purple-400' : 'bg-[#56af96]'}`}
            ...
            {/* --- Main Content --- */}
            <main className="relative z-10 w-[95%] max-w-[1600px] mx-auto px-4 lg:px-12 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-20 md:gap-10 items-center flex-grow pb-12 md:pb-0">
