...
// //     {/* Floating Code Particle System (Wahi same logic) */}
// //     <FloatingSymbol x="10%" y="20%" size="2rem" delay={0}>{'< />'}</FloatingSymbol>
// //     <FloatingSymbol x="80%" y="15%" size="1.5rem" delay={2}>{'{ }'}</FloatingSymbol>
// //     <FloatingSymbol x="50%" y="50%" size="3rem" delay={4}>#</FloatingSymbol>
// //     <FloatingSymbol x="30%" y="50%" size="1.2rem" delay={1}>&</FloatingSymbol>
...
// //     {/* --- 1. NEW FLOATING WALL SHELF (Monitor ke upar aur left side) --- */}
// //     <div className="relative bottom-[170px] left-[5%] md:left-[2%] flex flex-col items-center z-10">
// //         <div className="flex items-end gap-3 mb-[-1px]">
// //             {/* ENHANCED SNAKE PLANT (Sansevieria) */}
// //             <div className="relative group perspective-1000">
// //                 <motion.svg
// //                     width="55"
...
// //             </div>
// //         </div>
// //         {/* The Furniture Shelf Line (Wall Mounted) */}
// //         <div
// //             className={`w-40 h-2 rounded-full shadow-lg ${isDarkMode ? 'bg-[#1a0f21] border-b border-white/10' : 'bg-[#e5e7eb] border-b border-gray-400/50'}`}
// //         />
// //         {/* Decorative Shelf Bracket (Deewar se attach dikhane ke liye) */}
// //         <div className="flex justify-around w-full px-4">
// //             <div className={`w-1 h-3 opacity-20 ${isDarkMode ? 'bg-white' : 'bg-black'}`} />
// //             <div className={`w-1 h-3 opacity-20 ${isDarkMode ? 'bg-white' : 'bg-black'}`} />
// //         </div>
// //     </div>

// //     {/* --- 2. MAIN DESK ELEMENTS (Table Line par) --- */}
...
// //             {/* --- 1. WISPY STEAM (BHAF) --- */}
// //             <div className="absolute -top-24 -left-5 w-20 h-24 pointer-events-none z-20">
// //                 {[
// //                     { d: "M20,60 Q10,40 30,20 T20,0", delay: 0, duration: 5 },
// //                     { d: "M30,60 Q50,40 30,20 T40,0", delay: 2, duration: 6 },
// //                 ].map((wisp, i) => (
...
// //             <motion.div
// //                 className="w-50 h-34 rounded-2xl border-[3px] relative overflow-hidden transition-all duration-700 z-10"
// //                 style={{
// //                     backgroundColor: isDarkMode ? "#12121e" : "#f8f9fa",
// //                     borderColor: "#2d2d2d",
// //                     boxShadow: isDarkMode
